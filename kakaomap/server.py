...
app = Flask(
    __name__, 
    template_folder=os.path.join('C:/fintech_service/kakaomap', 'templates')
)
CORS(app)
...
def get_reviews(store_id):
    try:
        ...
        return jsonify(reviews)  # 항상 JSON 응답을 반환하도록 함
...
@app.route('/')
def home():
    return "Welcome to the API! Use /markers or /reviews/<store_id>."
